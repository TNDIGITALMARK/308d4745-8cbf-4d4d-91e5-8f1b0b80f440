...
export const metadata: Metadata = {
  title: "Roofus Inc. | Premier NYC Renovation Contractor",
  description: "Expert renovation and construction services in New York City. Specializing in kitchens, bathrooms, roofing, and commercial projects with 15+ years experience.",
};
